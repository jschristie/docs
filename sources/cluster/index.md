...
* Install Gluu CE following the [Deployment Page](../deployment/index.md) in `host-1`. Please note you must provide hostname of the cluster itself to `setup.py` script (`idp.gluu.org` in this example), not hostnames of individual nodes!
