...
Note: In order to have the new cert used for anything in oxtrust, i.e. anything hitting `/identity` and `/oxauth`, you only need to follow the steps for [updating the Apache web server](#apache-web-server-certificate-update-process).
